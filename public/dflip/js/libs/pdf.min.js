          ...
          switch (a) {
            ...
            case se:
              if (d && (T.test(d) || d == '+' || d == '-' || d == '.')) {
                ...
                if (
                  r &&
                  (Z(e) != c(J, o) || (o == 'file' && ($(e) || e.port !== null)) || (e.scheme == 'file' && !e.host))
                )
                  return;
                e.scheme = o;
                if (r) {
          ...
          R(e, [
            ...
            },
            {
              ...
              value: function e() {
                ...
                this.callback(
                  r || new i.RenderingCancelledException('Rendering cancelled, page '.concat(this.pageNumber), 'canvas')
                );
              },
            },
            {
                            ...
                            case 5:
                              ...
                              return u.abrupt(
                                ...
                                fetch(o)
                                  ...
                                  ['catch'](function (e) {
                                    throw new Error(
                                      'Unable to load '.concat(r.isCompressed ? 'binary ' : '') + 'CMap at: '.concat(o)
                                    );
                                  })
                              );
                            case 9:
    ...
    function (e, t, r) {
      ...
      s.prototype = {
        ...
        sendWithPromise: function e(t, r, a) {
          ...
          try {
            this.postMessage(
              { sourceName: this.sourceName, targetName: this.targetName, action: t, callbackId: i, data: r },
              a
            );
          } catch (e) {
            o.reject(e);
          ...
          return new n.ReadableStream(
            {
              start: function e(a) {
                ...
                u.postMessage(
                  { sourceName: c, targetName: f, action: t, streamId: l, data: r, desiredSize: a.desiredSize },
                  s
                );
                return i.promise;
              },
            ...
            },
            {
              ...
              value: function e(t) {
                ...
                this.cssStyle.textContent +=
                  '@font-face { font-family: "'.concat(t.loadedName, '";') + ' src: url('.concat(r, '); }\n');
              },
            },
            {
              key: 'setFont',
