    ...
    j = {
      ...
      _tap: function (a) {
        ...
        !d.draggingCorner &&
          !d.dragging &&
          r(f(a.target), b) &&
          (j._addEvent.call(b, 'tap', a), (a = j._eventSeq.call(b)) && b.trigger(a));
      },
        ...
        'double' == a.turn('display') && a.data().opts.autoCenter
          ? k[0]
            ? k[1]
              ...
              : ((g.width = a.width() / 2),
                (b = 'ltr' == c ? 0 : g.width),
                (a = h('ltr' == c ? l.left - i.left : l.left - i.left + g.width, l.top - i.top)))
            : ((g.width = a.width() / 2),
              (b = 'ltr' == c ? g.width : 0),
              (a = h('ltr' == c ? l.left - i.left + g.width : l.left - i.left, l.top - i.top)))
          : ((g.width = a.width()), (a = h(l.left - i.left, l.top - i.top)));
        d.zoomer ||
          (d.zoomer = f('<div />', {
            class: 'zoomer',
      ...
      zoomIn: function (a) {
        ...
        a =
          'undefined' != typeof a
            ? 'x' in a && 'y' in a
              ? h(a.x - g.x, a.y - g.y)
              : f.isTouch
                ? h(a.originalEvent.touches[0].pageX - g.x - s.left, a.originalEvent.touches[0].pageY - g.y - s.top)
        ...
        var r = function () {
          ...
          e.turn('zoom', c).css({ position: 'absolute', margin: '', top: 0, left: 0 });
          var a = e.offset();
      ...
      zoomOut: function (a) {
        ...
        if (e.zoomIn) {
          ...
          q &&
            ...
            (c.turn('view')[0]
              ? c.turn('view')[1] || (g.x = 'ltr' == c.turn('direction') ? g.x + k.width() / 4 : g.x - k.width() / 4)
              : (g.x = 'ltr' == c.turn('direction') ? g.x - k.width() / 4 : g.x + k.width() / 4));
          var r = f.findPos(c[0]);
          b = h(
          ...
          var n = function () {
            c[0].style.removeProperty
              ? (c[0].style.removeProperty(l + 'transition'),
                ...
                c.css({ position: 'relative', top: e.flipPosition.y, left: e.flipPosition.x }))
              : c
                  .transform('none')
                  .turn('zoom', 1)
                  .css({ margin: '', top: e.flipPosition.y, left: e.flipPosition.x, position: 'relative' });
            q && c.turn('center');
      ...
      scroll: function (a, b, d) {
        ...
        if (!b) {
          var g,
            b = h(Math.min(0, (j - this.width()) / 2), Math.min(0, (c.height() - this.height()) / 2)),
            c = h(
              j > this.width() ? j - this.width() : (j - this.width()) / 2,
              c.height() > this.height() ? c.height() - this.height() : (c.height() - this.height()) / 2
            );
      ...
      _eTurned: function (a, b) {
        if (1 != this.zoom('value')) {
          ...
          b > d.page
            ...
            : b < d.page && this.zoom('scroll', h(e.width(), d.scrollPos.y), !1, !0);
        }
      },
      _ePressed: function () {
      ...
      _eMouseDown: function (a) {
        f(this).data().zoom.draggingCur = f.isTouch
          ? h(a.originalEvent.touches[0].pageX, a.originalEvent.touches[0].pageY)
          : h(a.pageX, a.pageY);
        return !1;
      },
        ...
        b.touch &&
          ...
          (b.touch.speed.x =
            0 === b.touch.speed.x
              ...
              : (b.touch.speed.x + b.touch.motion.x / (c - b.touch.timestamp)) / 2),
          (b.touch.last = a),
          (b.touch.timestamp = c));
      },
      _eTouchEnd: function () {
        ...
        if (a.touch && 1 == f(this).zoom('value')) {
          ...
          50 > b && (-1 > a.touch.speed.x || -100 > a.touch.last.x - a.touch.initial.x)
