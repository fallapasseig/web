...
(function ($) {
  ...
  var has3d,
    ...
    turnMethods = {
      ...
      init: function (opts) {
        if (this.length > 1) throw turnError('This selector has more than 1 element');
      ...
      range: function (page) {
        ...
        if (page < 1 || page > data.totalPages) throw turnError('"' + page + '" is not a page for range');
      ...
      _flip: function (e) {
        ...
        if (opts.turn.data().opts.autoCenter) opts.turn.turn('center', opts.next);
      },
      ...
      _setPageLoc: function (page) {
        ...
        if (page == view[0] || page == view[1]) {
          ...
          data.pageWrap[page].css({ zIndex: 0, display: data.pageObjs[page].hasClass('fixed') ? '' : 'none' });
    ...
    flipMethods = {
      ...
      init: function (opts) {
        this.data({ f: { effect: opts.corners == 'r' || opts.corners == 'l' ? 'hard' : 'sheet' } });
      ...
      _moveFoldingPage: function (bool) {
        ...
        if (bool) {
          ...
          if (folding) {
            ...
            flipMethods.setData.call(this, { backParent: folding.parent(), folding: folding });
      ...
      _eventStart: function (e) {
        ...
        if (!data.disabled && !this.flip('isTurning')) {
          ...
          if (data.corner && flipMethods._foldingPage.call(this, data.corner)) {
            if (flipMethods._showFoldedPage.call(this, data.corner)) this.trigger('pressed', [data.point]);
