    ...
    turnMethods = {
      ...
      _eventReleased: function (e, point) {
        ...
        if (turnData.display == 'single') {
          outArea =
            point.corner == 'br' || point.corner == 'tr' ? point.x < page.width() / 2 : point.x > page.width() / 2;
        } else {
      ...
      _backGradient: function () {
        var data = this.data().f,
          ...
          gradient =
            ...
            (turnData.display == 'single' || (data.opts.page != 2 && data.opts.page != turnData.totalPages - 1));
        ...
        switch (data.effect) {
          case 'hard':
            ...
            data.wrapper.transform(
              'rotateY(' + angle + 'deg)' + 'translate3d(0px, 0px, ' + (this.attr('depth') || 0) + 'px)',
              parentOrigin
            );
              ...
              compute = function () {
                ...
                if (turnData.opts.gradients) {
                  ...
                  var endingPoint = flipMethods._c2.call(that, point.corner),
                    far =
                      Math.sqrt(Math.pow(endingPoint.x - point.x, 2) + Math.pow(endingPoint.y - point.y, 2)) / width;
