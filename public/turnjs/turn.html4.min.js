...
(function (f) {
  ...
  var r = '',
    n = { down: 'mousedown', move: 'mousemove', up: 'mouseup', over: 'mouseover', out: 'mouseout' },
    p = { backward: ['l'], forward: ['r'], all: ['l', 'r'] },
    x = ['single', 'double'],
    y = ['ltr', 'rtl'],
    z = { acceleration: !0, display: 'double', duration: 600, page: 1, gradients: !0, when: null },
    A = { acceleration: !0, corners: 'forward', cornerSize: 100, duration: 600, gradients: !0 },
    i = {
      init: function (a) {
        if (1 < this.length) throw k('This selector has more than 1 element');
        for (var b = ['Moz', 'Webkit', 'Khtml', 'O', 'ms'], c = b.length, d = ''; c--; )
          b[c] + 'Transform' in document.body.style && (d = '-' + b[c].toLowerCase() + '-');
        r = d;
        var e,
          b = 0,
          g = this.data(),
      ...
      destroy: function () {
        ...
        f(this)
          ...
          .unbind('turned')
          .unbind('zooming');
        for (f(document).unbind(n.move, a.docEvents.mouseMove).unbind(n.up, a.docEvents.mouseEnd); 0 !== a.totalPages; )
          ...
          f = function (a) {
            ...
            e.pagePlace[a] &&
              ...
              (e.pageWrap[c] = e.pageObjs[c].hasClass('fixed')
                ...
                : e.pageWrap[a].css(i._pageSize.call(d, c, !0)).attr('page', c)),
              e.pages[a] &&
      ...
      _missing: function (a) {
        for (var b = this.data(), c = this.turn('range', a), d = [], a = c[0]; a <= c[1]; a++)
      ...
      _turnPage: function (a, b) {
        ...
        e.pages[c] &&
          ...
          (e.tpage = d),
          g.next != d && ((g.next = d), (e.pagePlace[d] = g.page), (g.force = !0)),
          'single' == e.display
            ? 'ltr' == e.direction
      ...
      page: function (a) {
        ...
        return 0 < a && a <= b.totalPages
          ? (!b.done || -1 != f.inArray(a, this.turn('view')) ? i._fitPage.call(this, a) : i._turnPage.call(this, a),
            this)
          : b.page;
      },
      next: function () {
      ...
      _start: function (a, b, c) {
        ...
        a.isDefaultPrevented() ||
          ('single' == d.display &&
            c &&
            (('l' == c && 'ltr' == d.direction) || ('r' == c && 'rtl' == d.direction)
      ...
      _released: function (a, b) {
        ...
        if (200 > new Date().getTime() - e.time || c)
          a.preventDefault(), i._turnPage.call(g, e.opts.next, !1 === h._cornerActivated.call(d, b, 1));
        u.mouseAction = !1;
      },
      _flip: function (a) {
        a.stopPropagation();
        ...
        if (b.pageMv.length && 0 !== b.pageMv[0]) {
          ...
          for (a in b.pageWrap)
            if (
              ...
              b.pageWrap[a].css({ display: d.pageV[a] || c ? '' : 'none', 'z-index': d.pageZ[a] || (c ? -1 : 0) }),
              (c = b.pages[a]))
            )
              c.flip('z', d.partZ[a] || null), d.pageV[a] && c.flip('resize'), b.tpage && c.flip('disable', !0);
        } else
          for (a in b.pageWrap)
            j(a, b.pageWrap) &&
              ((d = i._setPageLoc.call(this, a)),
              b.pages[a] && b.pages[a].flip('disable', b.disabled || 1 != d).flip('z', null));
      },
      _updateShadow: function () {
        ...
        a = this.turn('view');
        c.shadow || (c.shadow = f('<div />', { class: 'shadow', css: q(0, 0, 0).css }).appendTo(this));
    ...
    h = {
      ...
      z: function (a) {
        var b = this.data().f;
        b.fwrapper &&
          ((b.opts['z-index'] = a), b.fwrapper.css({ 'z-index': a || parseInt(b.parent.css('z-index'), 10) || 0 }));
        return this;
      },
      _cAllowed: function () {
        var a = this.data().f,
      ...
      _cornerActivated: function (a) {
        var b = this.data().f,
          ...
          d = this.width(),
          e = this.height(),
          a = { x: Math.max(0, a.pageX - c.left), y: Math.max(0, a.pageY - c.top) },
          b = b.opts.cornerSize;
      ...
      _foldingPage: function () {
        ...
        if (b.turn)
          return (
            (a = b.turn.data()),
            'single' == a.display ? (a.pageObjs[b.next] ? a.pageObjs[0] : null) : a.pageObjs[b.next]
          );
      },
      _backGradient: function () {
        ...
        return (
          a.opts.gradients &&
          (!b || 'single' == b.data().display || (2 != a.opts.page && a.opts.page != b.data().totalPages - 1))
        );
      },
      resize: function (a) {
        var b = this.data().f,
          c = this.width(),
          d = this.height();
        a && (b.wrapper.css({ width: c, height: d }), b.fpage.css({ width: c, height: d }));
      },
      ...
      turnPage: function (a) {
        var b = this,
          c = this.data().f,
          a = { corner: c.corner ? c.corner.corner : a || h._cAllowed.call(this)[0] },
      ...
      _eventStart: function (a) {
        ...
        if (!b.disabled && !this.flip('isTurning')) {
          ...
          if (b.corner && h._foldingPage.call(this, b.corner))
            return h._showFoldedPage.call(this, b.corner) && this.trigger('pressed', [b.point]), !1;
          b.corner = null;
        }
      },
      ...
      if (a) {
        ...
        for (
          var c = [],
            ...
            i = function () {
              if (b.effect && e) {
                for (var f = [], j = Math.min(a.duration, new Date().getTime() - h), k = 0; k < d; k++)
