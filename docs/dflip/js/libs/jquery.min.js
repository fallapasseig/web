!(function (e, t) {
              ...
              (e = a[r]),
                a !== (n = i[r]) &&
                  (u && n && (p.isPlainObject(n) || (t = p.isArray(n)))
                    ? (t ? ((t = !1), (o = e && p.isArray(e) ? e : [])) : (o = e && p.isPlainObject(e) ? e : {}),
                      (a[r] = p.extend(u, o, n)))
                    : void 0 !== n && (a[r] = n));
        return a;
      }),
  ...
  var b = (function (e) {
    ...
    function ne(e, t, r, i) {
      ...
      if (((t ? t.ownerDocument || t : b) !== d && c(t), (r = r || []), !e || 'string' != typeof e)) return r;
      ...
      if (p && !i) {
        ...
        if (n.qsa && (!h || !h.test(e))) {
          if (((g = m = y), (x = t), (w = 9 === l && e), 1 === l && 'object' !== t.nodeName.toLowerCase())) {
            for (
              f = pe(e),
                (m = t.getAttribute('id')) ? (g = m.replace(Z, '\\$&')) : t.setAttribute('id', g),
                g = "[id='" + g + "'] ",
                u = f.length;
              u--;
            ...
            (n.qsa = G.test(i.querySelectorAll)) &&
              (oe(function (e) {
                (e.innerHTML = "<select t=''><option selected=''></option></select>"),
                  e.querySelectorAll("[t^='']").length && h.push('[*^$]=' + F + '*(?:\'\'|"")'),
                  e.querySelectorAll('[selected]').length || h.push('\\[' + F + '*(?:value|' + M + ')'),
              ...
              oe(function (e) {
                ...
                t.setAttribute('type', 'hidden'),
                  ...
                  e.querySelectorAll('[name=d]').length && h.push('name' + F + '*[*^$|!~]?='),
            ...
            (E = t
              ...
              : function (e, t) {
                  ...
                  var n,
                    ...
                    c = [t];
                  if (!o || !a)
                    return e === i ? -1 : t === i ? 1 : o ? -1 : a ? 1 : l ? _.call(l, e) - _.call(l, t) : 0;
    ...
    function pe(e, t) {
      ...
      for (s = e, l = [], u = r.preFilter; s; ) {
        for (a in ((!n || (i = $.exec(s))) && (i && (s = s.slice(i[0].length) || s), l.push((o = []))),
        (n = !1),
        (i = z.exec(s)) && ((n = i.shift()), o.push({ value: n, type: i[0].replace(W, ' ') }), (s = s.slice(n.length))),
        r.filter))
          !(i = V[a].exec(s)) ||
            (u[a] && !(i = u[a](i))) ||
      ...
      for (
        ...
        if ((n = r.relative[e[u].type])) f = [me(ge(f), n)];
          ...
          if ((n = r.filter[e[u].type].apply(null, e[u].matches))[y]) {
            ...
            return ye(
              u > 1 && ge(f),
              u > 1 && he(e.slice(0, u - 1).concat({ value: ' ' === e[u - 2].type ? '*' : '' })).replace(W, '$1'),
              n,
              i > u && be(e.slice(u, i)),
              o > i && be((e = e.slice(i))),
              o > i && he(e)
      ...
      var n = t.length > 0,
        ...
        o = function (o, a, l, u, c) {
          ...
          if (((m += g), n && g !== m)) {
            ...
            H.apply(u, y), c && !o && y.length > 0 && m + t.length > 1 && ne.uniqueSort(u);
          }
          return c && ((x = T), (s = b)), v;
        };
      return n ? ie(o) : o;
      ...
      (a = ne.compile =
        function (e, t) {
          var n,
            ...
            o = N[e + ' '];
          if (!o) {
            for (t || (t = pe(e)), n = t.length; n--; ) (o = be(t[n]))[y] ? r.push(o) : i.push(o);
            o = N(e, xe(i, r));
          }
          return o;
        }),
  ...
  (p.filter = function (e, t, n) {
    ...
    p.fn.extend({
      find: function (e) {
        ...
        return (
          ((n = this.pushStack(i > 1 ? p.unique(n) : n)).selector = this.selector ? this.selector + ' ' + e : e), n
        );
      },
      filter: function (e) {
  ...
  var N,
    ...
    S = (p.fn.init = function (e, t) {
      ...
      if ('string' == typeof e) {
        if (
          !(n = '<' === e.charAt(0) && '>' === e.charAt(e.length - 1) && e.length >= 3 ? [null, e, null] : k.exec(e)) ||
          (!n[1] && t)
        )
        ...
        if (n[1]) {
          if (
            ...
            p.merge(this, p.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : E, !0)),
  ...
  p.extend({
    ...
    p.fn.extend({
      ...
      closest: function (e, t) {
        for (
          var n, r = 0, i = this.length, o = [], a = x.test(e) || 'string' != typeof e ? p(e, t || this.context) : 0;
          i > r;
          r++
        )
      ...
      function (e, t) {
        p.fn[e] = function (n, r) {
          ...
          return (
            ...
            this.length > 1 && (D[e] || (i = p.unique(i)), A.test(e) && (i = i.reverse())),
            this.pushStack(i)
          );
        };
      }
  ...
  function _() {
    E.addEventListener
      ? (E.removeEventListener('DOMContentLoaded', M, !1), e.removeEventListener('load', M, !1))
      : (E.detachEvent('onreadystatechange', M), e.detachEvent('onload', M));
  }
  function M() {
    (E.addEventListener || 'load' === event.type || 'complete' === E.readyState) && (_(), p.ready());
  }
          ...
          return (
            s &&
              p.each(arguments, function (e, n) {
                for (var r; (r = p.inArray(n, s, r)) > -1; ) s.splice(r, 1), t && (i >= r && i--, o >= r && o--);
              }),
            this
          );
        },
    ...
    p.extend({
      ...
      ready: function (e) {
        if (!0 === e ? !--p.readyWait : !p.isReady) {
          ...
          (p.isReady = !0),
            (!0 !== e && --p.readyWait > 0) ||
              (L.resolveWith(E, [p]), p.fn.trigger && p(E).trigger('ready').off('ready'));
        }
      },
    }),
    ...
    if (void 0 === n && 1 === e.nodeType) {
      ...
      if ('string' == typeof (n = e.getAttribute(r))) {
        try {
          n =
            'true' === n ||
            ('false' !== n && ('null' === n ? null : +n + '' === n ? +n : B.test(n) ? p.parseJSON(n) : n));
        } catch (e) {}
        p.data(e, t, n);
      } else n = void 0;
    }
    ...
    if (p.acceptData(e)) {
      ...
      if (a[s]) {
        ...
        (n || (delete a[s].data, W(a[s]))) &&
          (o ? p.cleanData([e], !0) : d.deleteExpando || a != a.window ? delete a[s] : (a[s] = null));
      }
    }
  }
  p.extend({
      ...
      data: function (e, t) {
        ...
        if (void 0 === e) {
          if (this.length && ((i = p.data(o)), 1 === o.nodeType && !p._data(o, 'parsedAttrs'))) {
            for (n = a.length; n--; )
              0 === (r = a[n].name).indexOf('data-') && R(o, (r = p.camelCase(r.slice(5))), i[r]);
  ...
  var I = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
    ...
    V = (p.access = function (e, t, n, r, i, o, a) {
      var s = 0,
        l = e.length,
        u = null == n;
      if ('object' === p.type(n)) for (s in ((i = !0), n)) p.access(e, t, s, n[s], !0, o, a);
      else if (
        void 0 !== r &&
        ((i = !0),
        p.isFunction(r) || (a = !0),
  ...
  !(function () {
    ...
    (function () {
      ...
      for (t in { submit: !0, change: !0, focusin: !0 })
        (n = 'on' + t),
          (d[t + 'Bubbles'] = n in e) || (r.setAttribute(n, 't'), (d[t + 'Bubbles'] = !1 === r.attributes[n].expando));
      r = null;
    })();
  ...
  (p.event = {
        ...
        for (
          n.handler && ((n = (l = n).handler), (i = l.selector)),
            ...
            (c = v.handle) ||
              ((c = v.handle =
                function (e) {
                  return typeof p === O || (e && p.event.triggered === e.type)
                    ? void 0
    ...
    remove: function (e, t, n, r, i) {
      ...
      if (v && (c = v.events)) {
        for (u = (t = (t || '').match(H) || ['']).length; u--; )
          if (((h = g = (s = Z.exec(t[u]) || [])[1]), (m = (s[2] || '').split('.').sort()), h)) {
            for (
              d = p.event.special[h] || {},
            ...
            l &&
              !f.length &&
              ((d.teardown && !1 !== d.teardown.call(e, m, v.handle)) || p.removeEvent(e, h, v.handle), delete c[h]);
    ...
    trigger: function (t, n, r, i) {
      ...
      if (
        ...
        if (!i && !c.noBubble && !p.isWindow(r)) {
          for (l = c.delegateType || m, K.test(l + m) || (s = s.parentNode); s; s = s.parentNode) h.push(s), (d = s);
          d === (r.ownerDocument || E) && h.push(d.defaultView || d.parentWindow || e);
        }
        for (f = 0; (s = h[f++]) && !t.isPropagationStopped(); )
          (t.type = f > 1 ? l : c.bindType || m),
            (o = (p._data(s, 'events') || {})[t.type] && p._data(s, 'handle')) && o.apply(s, n),
            (o = a && s[a]) &&
              o.apply &&
              p.acceptData(s) &&
    ...
    dispatch: function (e) {
      ...
      if (((l[0] = e), (e.delegateTarget = this), !c.preDispatch || !1 !== c.preDispatch.call(this, e))) {
        for (s = p.event.handlers.call(this, e, u), t = 0; (o = s[t++]) && !e.isPropagationStopped(); )
          for (e.currentTarget = o.elem, a = 0; (i = o.handlers[a++]) && !e.isImmediatePropagationStopped(); )
            (!e.namespace_re || e.namespace_re.test(i.namespace)) &&
              ((e.handleObj = i),
              (e.data = i.data),
              void 0 !== (n = ((p.event.special[i.origType] || {}).handle || i.handler).apply(o.elem, l)) &&
                !1 === (e.result = n) &&
          ...
          if (1 === l.nodeType && (!0 !== l.disabled || 'click' !== e.type)) {
            for (i = [], o = 0; s > o; o++)
              void 0 === i[(n = (r = t[o]).selector + ' ')] &&
                (i[n] = r.needsContext ? p(n, this).index(l) >= 0 : p.find(n, this, null, [l]).length),
                i[n] && i.push(r);
    ...
    fix: function (e) {
      ...
      var t,
        ...
        a = this.fixHooks[i];
      for (
        a || (this.fixHooks[i] = a = Q.test(i) ? this.mouseHooks : G.test(i) ? this.keyHooks : {}),
            ...
            ? ((this.originalEvent = e),
              ...
              (this.isDefaultPrevented =
                ...
                (void 0 === e.defaultPrevented &&
                  (!1 === e.returnValue || (e.getPreventDefault && e.getPreventDefault())))
                  ? ee
                  : te))
            : (this.type = e),
          t && p.extend(this, t),
  ...
  var ie =
    ...
    ye = re(E).appendChild(E.createElement('div'));
  function be(e, t) {
    var n,
      r,
      i = 0,
      o =
        typeof e.getElementsByTagName !== O
          ? e.getElementsByTagName(t || '*')
          : typeof e.querySelectorAll !== O
            ? e.querySelectorAll(t || '*')
            : void 0;
    if (!o)
      for (o = [], n = e.childNodes || e; null != (r = n[i]); i++)
        !t || p.nodeName(r, t) ? o.push(r) : p.merge(o, be(r, t));
  ...
  (ve.optgroup = ve.option),
    ...
    p.extend({
      clone: function (e, t, n) {
        ...
        if (
          (d.html5Clone || p.isXMLDoc(e) || !ae.test('<' + e.nodeName + '>')
            ? (o = e.cloneNode(!0))
            : ((ye.innerHTML = e.outerHTML), ye.removeChild((o = ye.firstChild))),
          !((d.noCloneEvent && d.noCloneChecked) || (1 !== e.nodeType && 11 !== e.nodeType) || p.isXMLDoc(e)))
        )
          for (r = be(o), s = be(e), a = 0; null != (i = s[a]); ++a) r[a] && ke(i, r[a]);
        if (t)
          if (n) for (s = s || be(e), r = r || be(o), a = 0; null != (i = s[a]); a++) Ee(i, r[a]);
          else Ee(e, o);
        return (r = be(o, 'script')).length > 0 && Ne(r, !l && be(e, 'script')), (r = s = i = null), o;
      },
      buildFragment: function (e, t, n, r) {
        for (var i, o, a, s, l, u, c, f = e.length, h = re(t), m = [], g = 0; f > g; g++)
          if ((o = e[g]) || 0 === o)
            if ('object' === p.type(o)) p.merge(m, o.nodeType ? [o] : o);
              ...
              for (
                s = s || h.appendChild(t.createElement('div')),
                  ...
                  c = ve[l] || ve._default,
                  s.innerHTML = c[1] + o.replace(le, '<$1></$2>') + c[2],
                  i = c[0];
                i--;

              )
                s = s.lastChild;
              if ((!d.leadingWhitespace && se.test(o) && m.push(t.createTextNode(se.exec(o)[0])), !d.tbody))
                for (
                  i =
                    (o = 'table' !== l || ce.test(o) ? ('<table>' !== c[1] || ce.test(o) ? 0 : s) : s.firstChild) &&
                    o.childNodes.length;
                  i--;

                )
                  p.nodeName((u = o.childNodes[i]), 'tbody') && !u.childNodes.length && o.removeChild(u);
              for (p.merge(m, s.childNodes), s.textContent = ''; s.firstChild; ) s.removeChild(s.firstChild);
              s = h.lastChild;
            } else m.push(t.createTextNode(o));
        for (s && h.removeChild(s), d.appendChecked || p.grep(be(m, 'input'), xe), g = 0; (o = m[g++]); )
          if (
            (!r || -1 === p.inArray(o, r)) &&
            ((a = p.contains(o.ownerDocument, o)), (s = be(h.appendChild(o), 'script')), a && Ne(s), n)
          )
            for (i = 0; (o = s[i++]); ) he.test(o.type || '') && n.push(o);
        return (s = null), h;
      },
      cleanData: function (e, t) {
        for (
          var r, i, o, a, s = 0, l = p.expando, u = p.cache, c = d.deleteExpando, f = p.event.special;
          null != (r = e[s]);
          s++
        )
          if ((t || p.acceptData(r)) && (a = (o = r[l]) && u[o])) {
            ...
            u[o] &&
              (delete u[o],
              c ? delete r[l] : typeof r.removeAttribute !== O ? r.removeAttribute(l) : (r[l] = null),
              n.push(o));
          }
      },
    }),
    p.fn.extend({
      text: function (e) {
        return V(
          ...
          function (e) {
            return void 0 === e
              ? p.text(this)
              : this.empty().append(((this[0] && this[0].ownerDocument) || E).createTextNode(e));
          },
          null,
          e,
          arguments.length
      ...
      remove: function (e, t) {
        for (var n, r = e ? p.filter(e, this) : this, i = 0; null != (n = r[i]); i++)
          t || 1 !== n.nodeType || p.cleanData(be(n)),
            n.parentNode && (t && p.contains(n.ownerDocument, n) && Ne(be(n, 'script')), n.parentNode.removeChild(n));
        return this;
      },
      empty: function () {
          ...
          function (e) {
            ...
            if (
              !(
                'string' != typeof e ||
                fe.test(e) ||
                (!d.htmlSerialize && ae.test(e)) ||
                (!d.leadingWhitespace && se.test(e)) ||
                ve[(ue.exec(e) || ['', ''])[1].toLowerCase()]
              )
            ) {
              e = e.replace(le, '<$1></$2>');
              try {
                for (; r > n; n++) 1 === (t = this[n] || {}).nodeType && (p.cleanData(be(t, !1)), (t.innerHTML = e));
                t = 0;
              } catch (e) {}
            }
      ...
      replaceWith: function () {
        ...
        return (
          this.domManip(arguments, function (t) {
            (e = this.parentNode), p.cleanData(be(this)), e && e.replaceChild(t, this);
          }),
      ...
      domManip: function (e, t) {
        ...
        var n,
          ...
          m = e[0],
          g = p.isFunction(m);
        if (g || (c > 1 && 'string' == typeof m && !d.checkClone && pe.test(m)))
        ...
        if (
          c &&
          ((n = (l = p.buildFragment(e, this[0].ownerDocument, !1, this)).firstChild),
          1 === l.childNodes.length && (l = n),
          n)
        ) {
          for (o = (a = p.map(be(l, 'script'), Te)).length; c > u; u++)
            (r = l), u !== h && ((r = p.clone(r, !0, !0)), o && p.merge(a, be(r, 'script'))), t.call(this[u], r, u);
          if (o)
            for (s = a[a.length - 1].ownerDocument, p.map(a, Ce), u = 0; o > u; u++)
              (r = a[u]),
                he.test(r.type || '') &&
                  ...
                  (r.src
                    ...
                    : p.globalEval((r.text || r.textContent || r.innerHTML || '').replace(ge, '')));
          l = n = null;
        }
        return this;
      },
      ...
      function (e, t) {
        p.fn[e] = function (e) {
          for (var n, r = 0, i = [], a = p(e), s = a.length - 1; s >= r; r++)
            (n = r === s ? this : this.clone(!0)), p(a[r])[t](n), o.apply(i, n.get());
  ...
  function je(e) {
    ...
    return (
      n ||
        (('none' !== (n = De(e, t)) && n) ||
          ((t = (
            (Se = (Se || p("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement))[0]
              .contentWindow || Se[0].contentDocument
          ).document).write(),
          t.close(),
          (n = De(e, t)),
          Se.detach()),
  ...
  !(function () {
    ...
    (n.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>"),
      ((e = n.getElementsByTagName('a')[0]).style.cssText = 'float:left;opacity:.5'),
  ...
  e.getComputedStyle
    ...
    : E.documentElement.currentStyle &&
      ...
      (He = function (e, t, n) {
        var r,
          ...
          s = e.style;
        return (
          null == (a = (n = n || Le(e)) ? n[t] : void 0) && s && s[t] && (a = s[t]),
          _e.test(a) &&
            !Me.test(t) &&
            ((r = s.left),
    ...
    (function () {
      ...
      (s.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>"),
        ((t = s.getElementsByTagName('a')[0]).style.cssText = 'float:left;opacity:.5'),
          ...
          reliableMarginRight: function () {
            ...
            if (null == a && e.getComputedStyle) {
              ...
              (n = E.createElement('div')),
                ...
                ((i = r.appendChild(E.createElement('div'))).style.cssText = r.style.cssText =
  ...
  function Xe(e, t) {
    if (t in e) return t;
    for (var n = t.charAt(0).toUpperCase() + t.slice(1), r = t, i = Ie.length; i--; )
      ...
      (r = e[a]).style &&
        ...
        t
          ? (o[a] || 'none' !== n || (r.style.display = ''),
            '' === r.style.display && U(r) && (o[a] = p._data(r, 'olddisplay', je(r.nodeName))))
          : o[a] || ((i = U(r)), ((n && 'none' !== n) || !i) && p._data(r, 'olddisplay', i ? n : p.css(r, 'display'))));
    for (a = 0; s > a; a++)
      (r = e[a]).style &&
      ...
      'margin' === n && (a += p.css(e, n + X[o], !0, i)),
        r
          ...
          : ((a += p.css(e, 'padding' + X[o], !0, i)),
            'padding' !== n && (a += p.css(e, 'border' + X[o] + 'Width', !0, i)));
    return a;
  }
  function Ye(e, t, n) {
    var r = !0,
    ...
    if (0 >= i || null == i) {
      if (((0 > (i = He(e, t, o)) || null == i) && (i = e.style[t]), _e.test(i))) return i;
  ...
  p.extend({
    ...
    style: function (e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var i,
          ...
          s = p.camelCase(t),
          l = e.style;
        if (((t = p.cssProps[s] || (p.cssProps[s] = Xe(l, s))), (a = p.cssHooks[t] || p.cssHooks[s]), void 0 === n))
    ...
    css: function (e, t, n, r) {
      var i,
        ...
        s = p.camelCase(t);
      return (
        (t = p.cssProps[s] || (p.cssProps[s] = Xe(e.style, s))),
        (a = p.cssHooks[t] || p.cssHooks[s]) && 'get' in a && (o = a.get(e, !0, n)),
        void 0 === o && (o = He(e, t, r)),
        'normal' === o && t in ze && (o = ze[t]),
        '' === n || n ? ((i = parseFloat(o)), !0 === n || p.isNumeric(i) ? i || 0 : o) : o
      );
    },
  }),
    p.each(['height', 'width'], function (e, t) {
      p.cssHooks[t] = {
        get: function (e, n, r) {
          return n
            ? 0 === e.offsetWidth && Pe.test(p.css(e, 'display'))
              ? p.swap(e, $e, function () {
                  return Ye(e, t, r);
                })
              : Ye(e, t, r)
        ...
        set: function (e, n, r) {
          var i = r && Le(e);
          return Ve(0, n, r ? Je(e, t, r, d.boxSizing() && 'border-box' === p.css(e, 'boxSizing', !1, i), i) : 0);
        },
      };
    }),
    d.opacity ||
    ...
    (p.cssHooks.marginRight = Fe(d.reliableMarginRight, function (e, t) {
      return t ? p.swap(e, { display: 'inline-block' }, He, [e, 'marginRight']) : void 0;
    })),
    p.each({ margin: '', padding: '', border: 'Width' }, function (e, t) {
      (p.cssHooks[e + t] = {
        ...
        qe.test(e) || (p.cssHooks[e + t].set = Ve);
    }),
    p.fn.extend({
      css: function (e, t) {
        return V(
          ...
          function (e, t, n) {
            var r,
              ...
              a = 0;
            if (p.isArray(t)) {
              for (r = Le(e), i = t.length; i > a; a++) o[t[a]] = p.css(e, t[a], !1, r);
              return o;
            }
    ...
    nt = [
      function (e, t, n) {
        ...
        1 === e.nodeType &&
          ...
          'inline' === u &&
            'none' === p.css(e, 'float') &&
            (d.inlineBlockNeedsLayout && 'inline' !== c ? (m.zoom = 1) : (m.display = 'inline-block'))),
        n.overflow &&
          ((m.overflow = 'hidden'),
          d.shrinkWrapBlocks() ||
            f.always(function () {
        ...
        if (!p.isEmptyObject(h))
          for (r in (v ? 'hidden' in v && (g = v.hidden) : (v = p._data(e, 'fxshow', {})),
          o && (v.hidden = !g),
          g
            ? p(e).show()
            : f.done(function () {
          ...
          h))
            (a = at(g ? v[r] : 0, r, f)),
              r in v ||
                ((v[r] = a.start), g && ((a.end = a.start), (a.start = 'width' === r || 'height' === r ? 1 : 0)));
      },
    ],
    rt = {
      '*': [
        function (e, t) {
          var n = this.createTween(e, t),
            ...
            a = (p.cssNumber[e] || ('px' !== o && +r)) && et.exec(p.css(n.elem, e)),
            s = 1,
            l = 20;
          if (a && a[3] !== o) {
            (o = o || a[3]), (i = i || []), (a = +r || 1);
  ...
  (p.Animation = p.extend(st, {
    ...
    (function () {
      ...
      i.setAttribute('className', 't'),
        ...
        (r = (n = E.createElement('select')).appendChild(E.createElement('option'))),
  ...
  p.fn.extend({
    attr: function (e, t) {
      return V(this, p.attr, e, t, arguments.length > 1);
    },
      ...
      attr: function (e, t, n) {
        ...
        if (e && 3 !== o && 8 !== o && 2 !== o)
          return typeof e.getAttribute === O
            ? p.prop(e, t, n)
            : ((1 === o && p.isXMLDoc(e)) ||
                ((t = t.toLowerCase()), (r = p.attrHooks[t] || (p.expr.match.bool.test(t) ? ct : ut))),
              void 0 === n
    ...
    (ht && pt) ||
      (p.attrHooks.value = {
        set: function (e, t, n) {
          return p.nodeName(e, 'input') ? void (e.defaultValue = t) : ut && ut.set(e, t, n);
        },
      }),
    pt ||
      ((ut = {
  ...
  p.fn.extend({
    prop: function (e, t) {
      return V(this, p.prop, e, t, arguments.length > 1);
    },
    ...
    p.extend({
      ...
      prop: function (e, t, n) {
        ...
        if (e && 3 !== o && 8 !== o && 2 !== o)
          return (
            (1 !== o || !p.isXMLDoc(e)) && ((t = p.propFix[t] || t), (i = p.propHooks[t])),
            void 0 !== n
      ...
      return 'boolean' == typeof t && 'string' === n
        ...
        : this.each(
            p.isFunction(e)
              ...
              : function () {
                  if ('string' === n)
                    for (var t, r = 0, i = p(this), o = e.match(H) || []; (t = o[r++]); )
  ...
  (p.parseJSON = function (t) {
    ...
    (p.parseXML = function (t) {
      ...
      return (
        (n && n.documentElement && !n.getElementsByTagName('parsererror').length) || p.error('Invalid XML: ' + t), n
      );
    });
  var wt,
    Tt,
  ...
  try {
    ...
    ((Tt = E.createElement('a')).href = ''), (Tt = Tt.href);
  }
  function Ht(e) {
    return function (t, n) {
  ...
  (wt = At.exec(Tt.toLowerCase()) || []),
    p.extend({
      ...
      ajaxSetup: function (e, t) {
        return t ? _t(_t(e, p.ajaxSettings), t) : _t(p.ajaxSettings, e);
      },
      ajaxPrefilter: Ht(Dt),
      ajaxTransport: Ht(jt),
      ajax: function (e, t) {
        ...
        var n,
          ...
          w = {
            ...
            getResponseHeader: function (e) {
              var t;
              if (2 === b) {
                if (!u) for (u = {}; (t = Et.exec(o)); ) u[t[1].toLowerCase()] = t[2];
                t = u[e.toLowerCase()];
              }
        ...
        if (
          ...
          (w.success = w.done),
          (w.error = w.fail),
          (c.url = ((e || c.url || Tt) + '').replace(Ct, '').replace(St, wt[1] + '//')),
          ...
          (c.dataTypes = p
            ...
            .match(H) || ['']),
          null == c.crossDomain &&
            ((n = At.exec(c.url.toLowerCase())),
            (c.crossDomain = !(
              !n ||
              (n[1] === wt[1] &&
                n[2] === wt[2] &&
                (n[3] || ('http:' === n[1] ? '80' : '443')) === (wt[3] || ('http:' === wt[1] ? '80' : '443')))
            ))),
          ...
          return w;
        for (r in ((s = c.global) && 0 == p.active++ && p.event.trigger('ajaxStart'),
        (c.type = c.type.toUpperCase()),
        (c.hasContent = !kt.test(c.type)),
        (i = c.url),
        c.hasContent ||
          (c.data && ((i = c.url += (bt.test(i) ? '&' : '?') + c.data), delete c.data),
          !1 === c.cache &&
            (c.url = Nt.test(i) ? i.replace(Nt, '$1_=' + yt++) : i + (bt.test(i) ? '&' : '?') + '_=' + yt++)),
        c.ifModified &&
          (p.lastModified[i] && w.setRequestHeader('If-Modified-Since', p.lastModified[i]),
        ...
        w.setRequestHeader(
          ...
          c.dataTypes[0] && c.accepts[c.dataTypes[0]]
            ? c.accepts[c.dataTypes[0]] + ('*' !== c.dataTypes[0] ? ', ' + Lt + '; q=0.01' : '')
            : c.accepts['*']
        ),
        c.headers))
        ...
        function T(e, t, n, r) {
          ...
          2 !== b &&
            ...
            u
              ? (c.ifModified &&
                  ((T = w.getResponseHeader('Last-Modified')) && (p.lastModified[i] = T),
            ...
            m.fireWith(d, [w, C]),
            s && (f.trigger('ajaxComplete', [w, c]), --p.active || p.event.trigger('ajaxStop')));
        }
        return w;
      },
    ...
    (p.expr.filters.hidden = function (e) {
      return (
        ...
        (!d.reliableHiddenOffsets() && 'none' === ((e.style && e.style.display) || p.css(e, 'display')))
      );
    }),
  ...
  function Rt(e, t, n, r) {
    ...
    if (p.isArray(t))
      p.each(t, function (t, i) {
        n || Ft.test(e) ? r(e, i) : Rt(e + '[' + ('object' == typeof i ? t : '') + ']', i, n, r);
      });
  ...
  (p.param = function (e, t) {
    ...
    (p.ajaxSettings.xhr =
      void 0 !== e.ActiveXObject
        ? function () {
            return (
              (!this.isLocal && /^(get|post|head|put|delete|options)$/i.test(this.type) && It()) ||
              (function () {
                try {
              ...
              o.send((e.hasContent && e.data) || null),
                (t = function (n, i) {
                  ...
                  if (t && (i || 4 === o.readyState))
                    if ((delete $t[a], (t = void 0), (o.onreadystatechange = p.noop), i))
  ...
  p.ajaxSetup({
    ...
    (p.parseHTML = function (e, t, n) {
      ...
      return r
        ? [t.createElement(r[1])]
        : ((r = p.buildFragment([e], t, i)), i && i.length && p(i).remove(), p.merge([], r.childNodes));
    });
  var Vt = p.fn.load;
  ...
  (p.offset = {
    ...
    p.fn.extend({
      offset: function (e) {
        ...
        return o
          ? ((t = o.documentElement),
            p.contains(t, i)
              ? (typeof i.getBoundingClientRect !== O && (r = i.getBoundingClientRect()),
                (n = Yt(o)),
                {
      ...
      offsetParent: function () {
        return this.map(function () {
          for (var e = this.offsetParent || Jt; e && !p.nodeName(e, 'html') && 'static' === p.css(e, 'position'); )
            e = e.offsetParent;
          return e || Jt;
        });
      },
          ...
          function (e, r, i) {
            ...
            return void 0 === i
              ? o
                ...
                : e[r]
              : void (o ? o.scrollTo(n ? p(o).scrollLeft() : i, n ? i : p(o).scrollTop()) : (e[r] = i));
          },
          e,
          r,
          arguments.length,
    ...
    p.each(['top', 'left'], function (e, t) {
      p.cssHooks[t] = Fe(d.pixelPosition, function (e, n) {
        return n ? ((n = He(e, t)), _e.test(n) ? p(e).position()[t] + 'px' : n) : void 0;
      });
    }),
  ...
  return (
    (p.noConflict = function (t) {
      return e.$ === p && (e.$ = Qt), t && e.jQuery === p && (e.jQuery = Gt), p;
    }),
    typeof t === O && (e.jQuery = e.$ = p),
    p
  );
});
