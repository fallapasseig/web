(function () {
  ...
  var e,
    ...
    i = /Android/.test(r),
    o = /Android\s[0-2][^\d]/.test(r),
    a = /Android\s[0-4][^\d]/.test(r),
    s = r.indexOf('Chrom') >= 0,
    u = /Chrome\/(39|40)\./.test(r),
    c = r.indexOf('Trident') >= 0,
    f = /\b(iPad|iPhone|iPod)(?=;)/.test(r),
    d = r.indexOf('Opera') >= 0,
    l = /Safari\//.test(r) && !/(Chrome\/|Android\s)/.test(r);
  'undefined' == typeof PDFJS && (('undefined' != typeof window ? window : this).PDFJS = {}),
        ...
        window.btoa = function (t) {
          ...
          for (n = 0, r = t.length; n < r; n += 3) {
            var o = 255 & t.charCodeAt(n),
              ...
              f = n + 2 < r ? 63 & s : 64;
            i += e.charAt(o >> 2) + e.charAt(u) + e.charAt(c) + e.charAt(f);
          }
          return i;
        };
      }
      ...
      if (!('atob' in window)) {
        window.atob = function (e) {
          ...
          for (
            var t, n, r = 0, i = 0, o = '';
            (n = e.charAt(i++));
            ~n && ((t = r % 4 ? 64 * t + n : n), r++ % 4) ? (o += String.fromCharCode(255 & (t >> ((-2 * r) & 6)))) : 0
          )
    ...
    (function () {
      if (!('classList' in document.createElement('div'))) {
        ...
        Object.defineProperty(HTMLElement.prototype, 'classList', {
          get: function () {
            ...
            return Object.defineProperty(this, '_classList', { value: t, writable: !1, enumerable: !1 }), t;
          },
          enumerable: !0,
        });
      }
      function t(e, t, n, r) {
        ...
        '' === i[0] && i.shift();
        var o = i.indexOf(t);
        return o < 0 && n && i.push(t), o >= 0 && r && i.splice(o, 1), (e.className = i.join(' ')), o >= 0;
      }
    })(),
    'console' in window
      ? 'bind' in console.log ||
    ...
    c && (PDFJS.disableCreateObjectURL = !0),
    'language' in navigator || (PDFJS.locale = navigator.userLanguage || 'en-US'),
    (l || o || u || f) && ((PDFJS.disableRange = !0), (PDFJS.disableStream = !0)),
    (history.pushState && !o) || (PDFJS.disableHistory = !0),
    (function () {
      if (window.CanvasPixelArray)
        ...
        if (
          (s
            ? (t = (e = r.match(/Chrom(e|ium)\/([0-9]+)\./)) && parseInt(e[2]) < 21)
            : i
              ? (t = a)
              : l && (t = (e = r.match(/Version\/([0-9]+)\.([0-9]+)\.([0-9]+) Safari\//)) && parseInt(e[1]) < 6),
          t)
        ) {
    ...
    (f || i) && (PDFJS.maxCanvasPixels = 5242880),
    c && window.parent !== window && (PDFJS.disableFullscreen = !0),
